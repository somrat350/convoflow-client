    ...
    <div className="p-4 border-t border-slate-700/50">
      ...
      >
        ...
        <button
          ...
          className={`bg-slate-800/50 text-slate-400 hover:text-slate-200 cursor-pointer rounded-lg px-4 transition-colors ${
        ...
        <button
          ...
          className="bg-linear-to-r from-cyan-500 to-cyan-600 text-white rounded-lg px-4 py-2 font-medium hover:from-cyan-600 hover:to-cyan-700 transition-all disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed"
        >
          {isMessageSending ? (
